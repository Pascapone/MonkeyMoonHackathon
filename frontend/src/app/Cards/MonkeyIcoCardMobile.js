...
const MonkeyIcoCardMobile = ({icon, text, title, subtitle, minValue, maxValue, step, price}) => {
  ...
  return(
    <Card sx={{margin : 2, marginBottom : 5, height : '95%', borderRadius : 0, display : {xs : 'block', sm : 'none'}}}>          
      <CardHeader 
        title={title}
        ...
        subheader={subtitle}
      />    
      <CardContent sx={{marginTop : -1, overflow : 'visible'}}>   
        ...
        <Slider defaultValue={50} 
          ...
          sx={{width : '100%', marginRight : 10, marginTop : 3}}
          min={minValue}
          max={maxValue}
          step={step}
        ...
        <Stepper connector={<StepConnector ref={(el) => refCallback(el)} />} activeStep={activeStep} sx={{marginTop : 4, height : 50}} orientation='vertical'>
...
export default MonkeyIcoCardMobile